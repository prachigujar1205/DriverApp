        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Driver Information</h4>
                            <p class="card-description">
                                <a class="btn btn-success" href="/view-driver-info"><i class="mdi mdi-home me-2"></i>Back</a>
                            </p>

                            <form class="forms-sample" action="{{route('update.driver.info')}}" method="POST"
